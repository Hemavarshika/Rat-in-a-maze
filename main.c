...
int main(int argc,char **argv)
{
    ...
    else
    {
        ...
        fputs("\n5. 0 indicates dead end while 1 indicates that the block can be used to move the rat.",fp);
        fputs("\n6. The player to input the rats path in the form of a 6 x 6 matrix.",fp);
    }
    fclose(fp);*/
